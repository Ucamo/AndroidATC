...
//permissions to be writable
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (mUriMatcher.match(uri)) {
            //maps all mDatabase column names
            case NICKNAME:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        throw new SQLException("Fail to add a new record ino " + uri);
    }
    @Override
        ...
        switch (mUriMatcher.match(uri)) {
            ...
            case NICKNAME_ID:
                count = mDatabase.update(TABLE_NAME,
                        values,
                        ID + " = " + uri.getLastPathSegment() + (!TextUtils.
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (mUriMatcher.match(uri)) {
            ...
            case NICKNAME_ID:
                ...
                count = mDatabase.delete(TABLE_NAME,
                        ID + " = " + id + (!TextUtils.isEmpty(selection) ? "AND(" + selection + ')' : ""), selectionArgs);
                break;
            default:
                throw new IllegalArgumentException("Unsupported URI " + uri);
        }
    ...
    //class that creates and manages the providers mDatabase
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w(DBHelper.class.getName(),
                    "Upgrading mDatabase from version " + oldVersion +
                            " to " + newVersion +

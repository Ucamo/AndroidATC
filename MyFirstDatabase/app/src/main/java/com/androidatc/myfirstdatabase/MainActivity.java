...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,View.OnClickListener
{
    ...
    private void initializeViews(){
        ...
        mStudenName=(EditText)findViewById(R.id.student_name);
        mListView=(ListView)findViewById(R.id.student_list);

        Button mDeleteEngineers = (Button)findViewById(R.id.delete_engineers);
        mDeleteEngineers.setOnClickListener(this);
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.add_students:
                mdbAdapter.insertStudent(mStudenName.getText().toString(),mFaculties.getSelectedItemPosition()+1);
                loadList();
                break;

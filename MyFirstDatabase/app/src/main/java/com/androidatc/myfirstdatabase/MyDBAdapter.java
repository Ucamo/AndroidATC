...
public class MyDBAdapter {private static final String DATABASE_NAME = "data";
    ...
    {
        List<String> allStudents = new ArrayList<>();Cursor cursor = mSqLiteDatabase.query("students", null, null, null, null, null, null);
